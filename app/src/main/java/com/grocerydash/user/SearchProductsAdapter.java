...
public class SearchProductsAdapter extends RecyclerView.Adapter<SearchProductsAdapter.ViewHolder>{
    ...
    public SearchProductsAdapter(Context context, ArrayList<ProductInformation> productInformationList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        ...
        View view = inflater.inflate(R.layout.search_products, parent, false);

        return new SearchProductsAdapter.ViewHolder(view);
    }
    ...
    public void setProductFilter(ArrayList<ProductInformation> searchFilter){
        this.productInformationList = searchFilter;
